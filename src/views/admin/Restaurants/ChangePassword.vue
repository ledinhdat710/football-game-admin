            ...
            <div class="row justify-content-center">
              <div class="col-sm-10 col-md-8">
                ...
                <div class="mb-4">
                  ...
                  <span v-if="props.state.newPassword !== props.state.confirmPassword && props.state.newPassword !== '' && props.state.confirmPassword !== ''" class="invalid-feedback animated fadeIn">Passwords do not match.</span>
                </div>
              </div>
            </div>
      </div>
